...
<!-- 	 	<form action="login.me" method="post"> -->
 ...
 background: linear-gradient(270deg, rgba(140,175,242,1) 15%, rgba(126,169,242,1) 38%, rgba(110,156,236,1) 61%);" id="loginBtn" ><span>로그인<br></span></button> 
	...
	<a class="p-2" href="https://kauth.kakao.com/oauth/authorize?client_id=22b09290bdd926ec9d8b484522ae68db&redirect_uri=http://localhost:9280/WithTrip/kakao.me&response_type=code">
