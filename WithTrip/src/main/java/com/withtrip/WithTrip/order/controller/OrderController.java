...
public class OrderController {
   ...
   @RequestMapping("paymentDetail.od")
    ...
    public int rcancelPay(@RequestBody Order gOrder, HttpServletRequest request, HttpServletResponse response) throws Exception {
       ...
       String imp_key = URLEncoder.encode("3400037366165298", "UTF-8");
       String imp_secret =   URLEncoder.encode("6980a9ea4cd7ceca319de05a1786d366a27dc4968c50218a9333835ffad3008a21ffff0a4d0c41bf", "UTF-8");
...
// 여기부터 결제 검증에 필요
   ...
   public OrderController() {
	   ...
	   this.api = new IamportClient("3400037366165298","6980a9ea4cd7ceca319de05a1786d366a27dc4968c50218a9333835ffad3008a21ffff0a4d0c41bf");
   }
